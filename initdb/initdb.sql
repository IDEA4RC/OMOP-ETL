...
CREATE TABLE IF NOT EXISTS `cancer_episode` (
  ...
  `histology_subgroup_adipocytic_tumours` enum('LIPOSARCOMA_WELL_DIFF','DEDIFFERENTIATED_LIPOSARCOMA','MYXOID_LIPOSARCOMA','PLEOMORPHIC_LIPOSARCOMA','MYXOID_PLEOMORPHIC_LIPOSARCOMA') DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `patient` (
  ...
  `occurrence_of_other_cancer` enum('NEOPLASM_AND_OR_HAMARTOMA','ANGIOMATOSIS','CHORIOANGIOMA','HAMARTOMA','HEMANGIOMA','LYMPHANGIOMA','ATYPICAL_VASCULAR_LESION','NEOPLASTIC_DISEASE') DEFAULT NULL,
